  ...
  render() {
    ...
    <div className="row">
        ...
        <div className="card bg-light border-0 h-100">
            ...
            <div style={{padding: 12, width: 70, borderRadius: 5, fontSize: 30}} className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 mx-auto mx-auto"><i class="fa-solid fa-cloud-arrow-down"></i></div>
        ...
        <div className="card bg-light border-0 h-100">
            <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
            <div style={{padding: 12, width: 70, borderRadius: 5, fontSize: 30}} className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 mx-auto"><i class="fa-solid fa-cloud-arrow-down"></i></div>
